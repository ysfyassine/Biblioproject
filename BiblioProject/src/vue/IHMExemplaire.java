...
public class IHMExemplaire extends JFrame {
	...
	public IHMExemplaire() {
		...
		panel_3.setBounds(233, 47, 313, 464);
		panel_1.add(panel_3);
		...
		btnNewButton_1.setBounds(107, 371, 89, 23);
		...
		btnNewButton_2.setBounds(37, 415, 89, 23);
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int row = ExemplaireTable.getSelectedRow();
				String idr=(ExemplaireTable.getModel().getValueAt(row, 0)).toString();
				//control.UpdateExemplaire(Integer.parseInt(IdField.getText()), NomField.getText(),PrenomField.getText(), Integer.parseInt(idr));
				//refreshTable();
				//vider();*/
			}
		});
		btnNewButton_3.setBounds(187, 415, 89, 23);
